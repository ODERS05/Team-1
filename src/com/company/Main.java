...
public class Main {
    ...
    public static void main(String[] args, Object searchByIdOfFlight) {
        Scanner scanner = new Scanner(System.in);
        Managment managment = new JetManagment(5);
        ...
        do {
            ...
            switch (point) {
                ...
                case 3:
                    ...
                    Arrays.toString(new Flight[]{new Flight(flight.getId(), flight.getDepartureTime(), flight.getArrivalTime(), flight.getAircraft(), flight.getStatus())});
                    break;
                case 4:
                    System.out.print("Введите номер билета: ");
                    //   String search = scanner.next();
                    //   Flight exist = managment.searchFlightOnTicketNumber(searchByIdOfFlight);
                    //   if (exist != null) {
